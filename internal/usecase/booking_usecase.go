...
type BookingUsecase interface {
	...
	GetAllBookings(ctx context.Context, userUUID uuid.UUID, status string) ([]entity.Booking, error)
...
func (u *bookingUsecase) GetAllBookings(ctx context.Context, userUUID uuid.UUID, status string) ([]entity.Booking, error) {
	return u.repo.GetAll(ctx, userUUID, status)
}
